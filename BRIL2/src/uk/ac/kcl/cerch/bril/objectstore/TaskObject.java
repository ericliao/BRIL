...
public class TaskObject extends ObjectArtifact{
	 ...
	 * @param name Input file name that is added to the vector
	 */
	public void setInputFileNames(Vector<String>  names) {
		this.inputFileNames=names;
	}

	/**
	 * @param name Output file name that is added to the vector
	 */
	public void setOutputFileNames(Vector<String>  names) {
		this.outputFileNames=names;
	}
